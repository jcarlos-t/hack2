          ...
          <div className="flex justify-between items-center h-16">
            ...
            <button
              ...
              className="
                ...
                rounded-md text-purple-700 bg-purple-100
                hover:bg-purple-200 focus:outline-none
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              ].map(({ title, desc, icon, bgColor, textColor }) => (
                <div key={title} className="flex items-start space-x-4">
                  <div className="flex-shrink-0">
                    <div className={`flex items-center justify-center h-10 w-10 rounded-md ${bgColor} ${textColor}`}>
                      {icon}
                    </div>
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              {[
                { value: "10K+", label: "Gastos de ejemplo", color: "text-purple-600" },
                { value: "100%", label: "Gratis", color: "text-blue-600" },
                { value: "24/7", label: "Disponible", color: "text-green-600" },
